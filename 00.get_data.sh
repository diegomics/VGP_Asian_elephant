...
mkdir -p ~/Elephant_project/mEleMax1/genomic_data/arima
cd ~/Elephant_project/mEleMax1/genomic_data/arima
aws s3 cp s3://genomeark/species/Elephas_maximus/mEleMax1/genomic_data/arima/ . --recursive --no-sign-request
